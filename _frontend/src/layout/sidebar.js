...
function sidebar() {
  ...
  <section>
    ...
    <aside id="cta-button-sidebar" className="fixed top-0 left-0 z-40 w-96 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div className="h-full sm:px-16  py-4 overflow-y-auto bg-gray-500 dark:bg-gray-800">
        <h1>KK Marketplace</h1>
    ...
    <div className="p-4 sm:ml-96 bg-red-500">
