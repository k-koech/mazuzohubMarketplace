 ...
 <div className="w-full text-white bg-main-color">
        <div x-data="{ open: false }"
            ...
            <div className="p-4 flex flex-row items-center justify-between">
                <a href="#" className="text-lg text-black font-semibold tracking-widest uppercase rounded-lg focus:outline-none focus:shadow-outline">
                        Seller&apos;s profile
                </a>
                    ...
                    <ul
                        ...
                        <li className="flex items-center py-3">
                            ...
                            <span className="ml-auto"><span
                                    className="bg-sky-700 py-1 px-2 rounded text-white text-sm">Active</span></span>
                        </li>
                        <li className="flex items-center py-3">
                        ...
                        <div className="grid md:grid-cols-2 text-sm">
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                <div className="px-4 py-2">
                                    <a className="text-blue-800" href="mailto:jane@example.com">{authenticatedUser && authenticatedUser.email}</a>
                                </div>
                            </div>
                            <div className="grid grid-cols-2">
